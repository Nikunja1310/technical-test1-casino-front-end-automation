package com.borgataonline.casino.utility;

import com.borgataonline.casino.drivermanager.ManageBrowser;
...
//*************************** Action Methods ***************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/borgataonline/casino/screenshot/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/borgataonline/casino/screenshot/" + screenshotName + dateName + ".png";
    ...
    public static WebElement waitUntilVisibilityOfElementLocated(WebDriver driver, WebElement element, int time) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
        return wait.until(ExpectedConditions.visibilityOf(element));
    }

    public void useTryAndCatchToHandleAlertsException(){
        try {
            dismissAlert();
